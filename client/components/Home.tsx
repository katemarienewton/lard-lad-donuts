    ...
    >
      <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl p-8 max-w-2xl w-full text-center">
        ...
        {toppings && (
          ...
          <div className="px-6 py-8 mb-4 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition">
          <h2 className="text-2xl font-bold text-center">
            Your order is ready! One fresh donut with {randomFrosting} frosting and {randomTopping} on top! 😊
          </h2>
          </div>
